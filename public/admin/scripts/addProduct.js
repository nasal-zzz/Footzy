...
//             // Count currently visible image containers
//             const visibleImageContainers = document.querySelectorAll('#img-container:not(.d-none)');
            
//             // Prevent removal if only 2 images remain
//             if (visibleImageContainers.length <= 2) {
//                 alert('You must have at least two images.');
//                 return;
//             }
            
//             // Find the parent container of the current button
//             const imageContainer = this.closest('#img-container');
...
//             // Optionally hide the entire container
...
//             // Optional: If you want to remove the image from the server
//             // You might need to add a hidden input or data attribute to track which image to remove
//         });
//     });
// });
